...
const getToken = ()=>("TURBOPACK compile-time truthy", 1) ? localStorage.getItem(TOKEN_KEY) : "TURBOPACK unreachable";
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const stored = localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TOKEN_KEY"]);
            if (stored) {
                setToken(stored);
                refreshUser().finally({
...
"[project]/frontend/src/lib/i18n-data.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    en: {
        ...
        auth: {
            ...
            register: {
                ...
                subtitle: 'Free plan — 3 analyses/month, no card required',
                name: 'Name',
                optional: '(optional)',
                email: 'Email',
                password: 'Password',
        ...
        dashboard: {
            ...
            limitDesc: 'Free plan: 3 analyses/month. Upgrade to Pro for unlimited.',
            upgrade: 'Upgrade',
            heading: 'What do you need?',
            subheading: 'Choose an analysis type to get started',
            getStarted: 'Get started',
            back: 'Back',
            editInputs: 'Edit inputs',
            newAnalysis: 'New analysis',
            analyzing: 'Analyzing…',
            aiRunning: 'Running AI analysis…',
            aiWait: 'This usually takes 5–10 seconds',
            ...
            modes: {
                ...
                visa: {
                    ...
                    fields: {
                        nationality: 'Your nationality / passport',
                        profession: 'Profession / Job title',
                        destination: 'Destination country',
                        goals: 'Stay purpose'
                    }
                ...
                cost: {
                    ...
                    fields: {
                        ...
                        profession: 'Profession (for housing needs)',
            ...
            results: {
                ...
                proTips: 'Pro tips',
                docChecklist: 'Documents checklist',
                tips: 'Tips',
                monthlyBreakdown: 'Monthly breakdown',
                comparison: 'Comparison',
                savingTips: 'Money-saving tips',
                visa: 'Visa',
                monthly: 'Monthly',
                setup: 'Setup',
                pros: 'Pros',
    ...
    ru: {
        ...
        auth: {
            ...
            register: {
                ...
                subtitle: 'Бесплатно — 3 анализа в месяц, без карты',
                name: 'Имя',
        ...
        dashboard: {
            ...
            limitDesc: 'Бесплатный план: 3 анализа в месяц. Перейди на Pro для безлимита.',
            upgrade: 'Улучшить',
            heading: 'Что тебе нужно?',
            subheading: 'Выбери тип анализа, чтобы начать',
            getStarted: 'Начать',
            back: 'Назад',
            editInputs: 'Изменить данные',
            newAnalysis: 'Новый анализ',
            analyzing: 'Анализирую…',
            aiRunning: 'Запускаю ИИ анализ…',
            aiWait: 'Обычно занимает 5–10 секунд',
            fieldRequired: 'обязательное поле',
            modes: {
                country: {
                    label: 'Анализ стран',
                    description: 'Найди 5 лучших стран под твой профиль',
                    fields: {
                ...
                plan: {
                    label: 'План переезда',
                    description: 'Пошаговый план для конкретной страны',
                    fields: {
                        profession: 'Профессия / Должность',
                        budget: 'Ежемесячный бюджет',
                        language: 'Рабочий язык',
                ...
                visa: {
                    label: 'Визовое руководство',
                    description: 'Визы, требования и процедуры',
                    fields: {
                        nationality: 'Гражданство / паспорт',
                        profession: 'Профессия / Должность',
                        destination: 'Страна назначения',
                        goals: 'Цель пребывания'
                    }
                },
                cost: {
                    label: 'Оценка расходов',
                    description: 'Детальная разбивка расходов по месяцам',
                    fields: {
                        destination: 'Страна / Город назначения',
                        lifestyle: 'Уровень жизни',
                        profession: 'Профессия (для подбора жилья)',
                        goals: 'Особые требования'
                    }
                }
            },
            results: {
                ...
                proTips: 'Советы Pro',
                docChecklist: 'Чеклист документов',
                tips: 'Советы',
    ...
    es: {
        ...
        auth: {
            ...
            register: {
                ...
                subtitle: 'Plan gratuito — 3 análisis/mes, sin tarjeta',
                name: 'Nombre',
                optional: '(opcional)',
                email: 'Email',
                password: 'Contraseña',
        ...
        dashboard: {
            ...
            limitDesc: 'Plan gratuito: 3 análisis/mes. Actualiza a Pro para ilimitados.',
            upgrade: 'Mejorar',
            heading: '¿Qué necesitas?',
            subheading: 'Elige un tipo de análisis para comenzar',
            getStarted: 'Comenzar',
            back: 'Volver',
            editInputs: 'Editar datos',
            newAnalysis: 'Nuevo análisis',
            analyzing: 'Analizando…',
            aiRunning: 'Ejecutando análisis de IA…',
            aiWait: 'Esto suele tardar 5–10 segundos',
            fieldRequired: 'es obligatorio',
            modes: {
                country: {
                    label: 'Análisis de países',
                    description: 'Encuentra los 5 mejores países para tu perfil',
                    fields: {
                        profession: 'Profesión / Puesto',
                        budget: 'Presupuesto mensual',
                        language: 'Idioma de trabajo',
                        goals: 'Objetivos de reubicación'
                    }
                },
                plan: {
                    label: 'Plan de reubicación',
                    description: 'Plan paso a paso para un país específico',
                    fields: {
                        profession: 'Profesión / Puesto',
                        budget: 'Presupuesto mensual',
                        language: 'Idioma de trabajo',
                ...
                visa: {
                    label: 'Orientación de visas',
                    description: 'Opciones de visa, requisitos y proceso',
                    fields: {
                        nationality: 'Tu nacionalidad / pasaporte',
                        profession: 'Profesión / Puesto',
                        destination: 'País de destino',
                        goals: 'Propósito de estadía'
                    }
                },
                cost: {
                    label: 'Estimación de costos',
                    description: 'Desglose detallado de costos mensuales',
                    fields: {
                        destination: 'País / Ciudad de destino',
                        lifestyle: 'Nivel de estilo de vida',
                        profession: 'Profesión (para necesidades de vivienda)',
                        goals: 'Requisitos especiales'
                    }
                }
            },
            results: {
    ...
    de: {
        ...
        auth: {
            ...
            register: {
                ...
                subtitle: 'Kostenlos — 3 Analysen/Monat, keine Karte',
                name: 'Name',
                optional: '(optional)',
                email: 'E-Mail',
                password: 'Passwort',
        ...
        dashboard: {
            ...
            limitTitle: 'Monatliches Limit erreicht',
            limitDesc: 'Kostenloser Plan: 3 Analysen/Monat. Upgrade auf Pro für unbegrenzte.',
            upgrade: 'Upgraden',
            heading: 'Was brauchst du?',
            subheading: 'Wähle einen Analysetyp, um zu beginnen',
            getStarted: 'Starten',
            back: 'Zurück',
            editInputs: 'Eingaben bearbeiten',
            newAnalysis: 'Neue Analyse',
            analyzing: 'Analysiere…',
            aiRunning: 'KI-Analyse wird ausgeführt…',
            aiWait: 'Das dauert normalerweise 5–10 Sekunden',
            fieldRequired: 'ist erforderlich',
            modes: {
                country: {
                    label: 'Länderanalyse',
                    description: 'Finde die 5 besten Länder für dein Profil',
                    fields: {
                        profession: 'Beruf / Berufsbezeichnung',
                        budget: 'Monatliches Budget',
                        language: 'Arbeitssprache',
                        goals: 'Umzugsziele'
                    }
                },
                plan: {
                    label: 'Relocation-Plan',
                    description: 'Schrittweiser Plan für ein bestimmtes Land',
                    fields: {
                        profession: 'Beruf / Berufsbezeichnung',
                        budget: 'Monatliches Budget',
                        language: 'Arbeitssprache',
                ...
                visa: {
                    label: 'Visa-Beratung',
                    description: 'Visaoptionen, Anforderungen und Prozess',
                    fields: {
                        nationality: 'Deine Nationalität / Reisepass',
                        profession: 'Beruf / Berufsbezeichnung',
                        destination: 'Zielland',
                        goals: 'Aufenthaltszweck'
                    }
                },
                cost: {
                    label: 'Kostenschätzung',
                    description: 'Detaillierte monatliche Kostenaufschlüsselung',
                    fields: {
                        destination: 'Zielland / Stadt',
                        lifestyle: 'Lebensstilniveau',
                        profession: 'Beruf (für Wohnbedarf)',
                        goals: 'Besondere Anforderungen'
                    }
                }
            },
            results: {
                ...
                proTips: 'Pro-Tipps',
                docChecklist: 'Dokument-Checkliste',
                tips: 'Tipps',
...
"[project]/frontend/src/lib/i18n.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function I18nProvider({ children }) {
    _s();
    const [locale, setLocaleState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('en');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "I18nProvider.useEffect": ()=>{
            const stored = localStorage.getItem('relo_lang');
            if (stored && __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$i18n$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"][stored]) setLocaleState(stored);
        }
    }["I18nProvider.useEffect"], []);
    const setLocale = (l)=>{
        setLocaleState(l);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(I18nContext.Provider, {
        value: {
            locale,
            setLocale,
            t: __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$i18n$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"][locale]
        },
        children: children
    }, void 0, false, {
...
//# sourceMappingURL=frontend_src_lib_0tn6.c.._.js.map