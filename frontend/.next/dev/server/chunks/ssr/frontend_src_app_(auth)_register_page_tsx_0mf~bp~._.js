...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].post('/api/auth/register', {
                name,
                email,
                password
            });
...
//# sourceMappingURL=frontend_src_app_%28auth%29_register_page_tsx_0mf~bp~._.js.map